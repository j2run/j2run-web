...
start_forwarding() {
  ...
  ssh -fN -L 27018:127.0.0.1:27017 $SSH_USERNAME@$SSH_HOST &

  echo "+ 6379 -> 127.0.0.1:6380"
  ssh -fN -L 6380:127.0.0.1:6379 $SSH_USERNAME@$SSH_HOST &
}

# Function to stop port forwarding
stop_forwarding() {
  echo "Stopping port forwarding..."
  pkill -f "ssh -fN -L 6380:127.0.0.1:6379 $SSH_USERNAME@$SSH_HOST"
  pkill -f "ssh -fN -L 27018:127.0.0.1:27017 $SSH_USERNAME@$SSH_HOST"
  isExit=1
}
